...
################################################################################
## Form generated from reading UI file 'splash_screen_3.ui'
##
...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen):
        ...
        SplashScreen.resize(484, 448)
        self.centralwidget = QWidget(SplashScreen)
        self.centralwidget.setObjectName(u"centralwidget")
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 10, 461, 431))
        self.frame = QFrame(self.widget)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(0, 0, 231, 430))
        self.frame.setStyleSheet(u"border-image: url(:/images/images/images/khoidong.png);\n"
"border-top-left-radius: 50px;")
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.frame_2 = QFrame(self.widget)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setGeometry(QRect(230, 0, 231, 430))
        self.frame_2.setStyleSheet(u"background-image: url(:/images/images/images/5172658.jpg);\n"
"border-bottom-right-radius: 50px;")
        self.frame_2.setFrameShape(QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QFrame.Raised)
        self.circularProgressBarBase = QFrame(self.frame_2)
        self.circularProgressBarBase.setObjectName(u"circularProgressBarBase")
        self.circularProgressBarBase.setGeometry(QRect(-20, 70, 320, 320))
...
"}")
        ...
        self.layoutWidget.setGeometry(QRect(40, 50, 240, 227))
